...
<div class = 'container'>
    ...
    <div class="container col-6 offset-md-10">
        ...
        <img class="pr-image" alt ='team member1' src = "<?php echo $image2 ?>" width="251"/>
    </div>
    <div class="spacersm"></div>
    ...
    <div class="container col-6 offset-md-1">
        ...
        <img class="pr-image" alt ='team member3' src = "<?php echo $image3 ?>" width="251"/>
    </div>
    <div class="spacersm"></div>
    ...
    <div class="container col-6 offset-md-10">
        ...
        <img class="pr-image" alt ='team member3' src = "<?php echo $image4 ?>" width="251"/>
    </div>
    <div class="spacersm"></div>
